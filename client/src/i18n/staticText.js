...
const supplemental = {
  ...
  "RESOLUTION_PROPOSED": { it: "SOLUZIONE FORNITA", es: "SOLUCION PROPORCIONADA", fr: "SOLUTION FOURNIE" },
  "CUSTOMER_RESPONDED_AFTER_RESOLUTION": { it: "IN REVISIONE", es: "EN REVISION", fr: "EN REVISION" },
  "REOPENED": { it: "RIAPERTO", es: "REABIERTO", fr: "ROUVERT" },
  "AUTO_CLOSED": { it: "CHIUSO", es: "CERRADO", fr: "FERME" },
