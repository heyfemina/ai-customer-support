...
export default function StatCard({ title, value, icon: Icon, trend = "+8%", tone = "sky" }) {
  ...
  return (
    <Card className="relative overflow-hidden p-5 transition duration-200 hover:-translate-y-0.5 hover:border-teal-200 hover:shadow-[0_20px_44px_rgba(15,23,42,0.08)]">
