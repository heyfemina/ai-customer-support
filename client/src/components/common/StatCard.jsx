...
export default function StatCard({ title, value, icon: Icon, trend = "+8%", tone = "sky" }) {
  ...
  return (
    <Card className="relative overflow-hidden p-5 transition duration-200 hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md">
      <div className="absolute inset-x-0 top-0 h-1 bg-blue-900" />
      ...
      <div className="mt-5 inline-flex items-center gap-1 rounded-md bg-blue-50 px-2 py-1 text-xs font-bold text-blue-700 ring-1 ring-blue-100">
