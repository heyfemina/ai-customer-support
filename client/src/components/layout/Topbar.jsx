...
export default function Topbar({ onMenu }) {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200/80 bg-white/86 px-4 shadow-[0_10px_28px_rgba(15,23,42,0.05)] backdrop-blur-xl lg:px-8">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden h-10 w-80 items-center gap-2 rounded-md border border-slate-200 bg-white px-3 shadow-sm transition focus-within:border-teal-500 focus-within:bg-white focus-within:ring-4 focus-within:ring-teal-100 md:flex">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="hidden items-center gap-3 sm:flex">
          <div className="grid h-10 w-10 place-items-center rounded-md bg-teal-600 text-sm font-bold text-white shadow-sm">{initials(user?.name)}</div>
