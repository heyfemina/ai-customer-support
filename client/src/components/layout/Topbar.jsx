  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200/80 bg-white/90 px-4 shadow-[0_1px_2px_rgba(15,23,42,0.03)] backdrop-blur lg:px-8">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button className="relative grid h-10 w-10 place-items-center rounded-md border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:bg-slate-50 hover:text-slate-950" title={notifications[0]?.message || t("chat.notifications")} onClick={clearNotifications}>
