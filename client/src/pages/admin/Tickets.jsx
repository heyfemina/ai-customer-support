    ...
    <>
      ...
      <Card className="mb-4 p-4">
        <div className="grid gap-3 md:grid-cols-[1fr_170px_170px_170px_170px]">
          ...
          <select className="app-field" value={filters.priority} onChange={(event) => setFilters({ ...filters, priority: event.target.value })}>
          ...
          <select className="app-field" value={filters.agentId} onChange={(event) => setFilters({ ...filters, agentId: event.target.value })}>
