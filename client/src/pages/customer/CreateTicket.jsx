    ...
    <>
      ...
      <Card className="p-5">
        ...
        <form className="grid gap-5 lg:grid-cols-2" onSubmit={submit}>
          ...
          <label className="block"><span className="app-label">Category</span><select className="app-field mt-1" value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}><option>General</option><option>Billing</option><option>Technical</option><option>AI</option><option>Compliance</option></select></label>
