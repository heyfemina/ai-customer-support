  ...
  return (
    <Card className="p-6 sm:p-7">
      ...
      <form className="mt-6 space-y-4" onSubmit={submit}>
        <input className="h-11 w-full rounded-md border border-slate-200 px-3 text-center text-lg font-bold tracking-[0.3em] outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-100" value={otp} onChange={(event) => setOtp(event.target.value)} maxLength={6} />
      ...
      <button className="mt-4 text-sm font-semibold text-teal-700" onClick={resend}>Resend OTP</button>
